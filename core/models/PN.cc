...
namespace csimModel
{
    ...
    int PN::iterateDC()
    {
        ...
        addY(getNode(0), getNode(0), +m_geq), addY(getNode(0), getNode(1), -m_geq);
        addY(getNode(1), getNode(0), -m_geq), addY(getNode(1), getNode(1), +m_geq);
        addI(getNode(0), -m_Ieq);
        addI(getNode(1), +m_Ieq);
    ...
    {
        /* Linearized for small-signal analysis */
        addY(getNode(0), getNode(0), +m_geq), addY(getNode(0), getNode(1), -m_geq);
        addY(getNode(1), getNode(0), -m_geq), addY(getNode(1), getNode(1), +m_geq);
        addI(getNode(0), -m_Ieq);
        addI(getNode(1), +m_Ieq);
